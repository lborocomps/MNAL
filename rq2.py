...
#     pooled_outputs = np.concatenate((pooled_outputs.astype(np.float32), pooled_output.detach().cpu().numpy()), axis=0)
#   end_time = time.time()
...
if start_from_step == 0:
  ...
  with open(f'/initial_data/run{run}_sample_size{initial_size}_initial_data.pkl','rb') as pklfile:
    files = pickle.load(pklfile)
  ...
  model.load_state_dict(torch.load(f'/initial_data/run{run}_sample_size{initial_size}_model_weight'))
  ...
  if pseudo_setting == 1:
    with open(f'/rq2/data/rq2_initial_size{initial_size}_sample_size{sample_size}_run_{run+1}_step{start_from_step}-{sample_times}_{MODE}_{f1_flag}{f2_flag}{f3_flag}{f4_flag}{f5_flag}_pseudo{pseudo_setting}_ratio{ratio}.pkl','rb') as pklfile:
      files = pickle.load(pklfile)
  ...
  if pseudo_setting == 1:
    ...
    with open(f'/rq2/data/rq2_initial_size{initial_size}_sample_size{sample_size}_run_{run+1}_step{start_from_step}-{sample_times}_{MODE}_{f1_flag}{f2_flag}{f3_flag}{f4_flag}{f5_flag}_pseudo{pseudo_setting}_ratio{ratio}.pkl','wb') as pklfile:
...
for sample_time in range(start_from_step,sample_times):
  ...
  with open(f'/rq2/data/rq2_mid_initial_size{initial_size}_sample_size{sample_size}_run_{run+1}_step{sample_time+1}-{sample_times}_{MODE}_{f1_flag}{f2_flag}{f3_flag}{f4_flag}{f5_flag}_pseudo{pseudo_setting}_ratio{ratio}.pkl','wb') as pklfile:
    pickle.dump(files, pklfile)
  ...
  if pseudo_setting == 1:
    files = bug_annotated_ids, bug_pool_ids, y_true_labeled, metrics_mixed, metrics_all, saved_indices, tmp2, read_values, iden_values
    with open(f'/rq2/data/rq2_initial_size{initial_size}_sample_size{sample_size}_run_{run+1}_step{sample_time+1}-{sample_times}_{MODE}_{f1_flag}{f2_flag}{f3_flag}{f4_flag}{f5_flag}_pseudo{pseudo_setting}_ratio{ratio}.pkl','wb') as pklfile:
      pickle.dump(files, pklfile)
  elif pseudo_setting == 2:
    files = bug_annotated_ids, bug_pool_ids, y_true_labeled, metrics_mixed, metrics_all, saved_indices, tmp2, bug_annotated_ids_real, y_true_labeled_real, read_values, iden_values
    with open(f'/rq2/data/rq2_initial_size{initial_size}_sample_size{sample_size}_run_{run+1}_step{sample_time+1}-{sample_times}_{MODE}_{f1_flag}{f2_flag}{f3_flag}{f4_flag}{f5_flag}_pseudo{pseudo_setting}_ratio{ratio}.pkl','wb') as pklfile:

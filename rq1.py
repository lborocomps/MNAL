...
if start_from_step == 0:
  ...
  with open(f'/rq1/data/rq1_initial_size{initial_size}_sample_size{sample_size}_run_{run+1}_step{start_from_step}-{sample_times}_{MODE}_{f1_flag}{f2_flag}{f3_flag}{f4_flag}{f5_flag}.pkl','rb') as pklfile:
    files = pickle.load(pklfile)
  ...
  with open(f'/rq1/data/rq1_initial_size{initial_size}_sample_size{sample_size}_run_{run+1}_step{start_from_step}-{sample_times}_{MODE}_{f1_flag}{f2_flag}{f3_flag}{f4_flag}{f5_flag}.pkl','wb') as pklfile:
